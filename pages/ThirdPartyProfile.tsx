            ...
            <div className="flex flex-col lg:flex-row gap-8">
                <div className="lg:w-[320px] shrink-0 space-y-6">
                    <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-xl shadow-slate-200/50 flex flex-col items-center text-center">
                        ...
                        <p className="text-primary font-bold text-sm mb-2">{company.specialty}</p>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-5 flex items-center justify-between shadow-sm">
                            <div>
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Horas Faturadas</p>
                        ...
                        <div className="bg-white rounded-2xl border border-slate-200 p-5 flex flex-col justify-center shadow-sm">
                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1 flex items-center gap-1.5">
                                <AlertTriangle size={12} className="text-orange-400" /> Histórico Operacional
                            </p>
                            <h4 className="text-sm font-black text-slate-900 line-clamp-2" title={mostFrequentAsset}>{mostFrequentAsset}</h4>
                            <p className="text-[10px] text-slate-400 font-semibold mt-1">Alvo mais acionado pela parceira</p>
                        </div>
                    </div>
                </div>
                                ...
                                >
                                    <div className="flex gap-4 min-w-0">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <h4 className="text-base font-black text-slate-900 group-hover:text-primary transition-colors truncate text-left">{order.title}</h4>
