...
const TechnicianProfile = () => {
    ...
    const loadTechnicianData = async () => {
        try {
            ...
            // Load technician work orders with assets and users joined
            ...
            // Map the data to include joined fields more cleanly
    ...
    const handleUpdateTechnician = async (data: TechnicianData) => {
        try {
    ...
    // === KPIs Calculations (must be above early returns - React Hook rules) ===
    const mttr = useMemo(() => {
    ...
    if (!technician) {
        return (
            <div className="p-8 text-center bg-white rounded-3xl border border-slate-200 shadow-xl">
                ...
                <h3 className="text-xl font-black text-slate-900">Técnico não encontrado</h3>
                <button
                ...
                <div className="lg:w-[320px] shrink-0 space-y-6">
                        ...
                        <div className="relative mb-6">
                            {technician.avatar ? (
                                <img
                                    ...
                                    className="size-32 rounded-3xl object-cover ring-4 ring-slate-100 shadow-lg"
                                    alt={technician.name}
                                />
                            ) : (
                            ...
                            <div className={`absolute -bottom-2 -right-2 size-6 rounded-full border-4 border-white ${technician.status === 'Ativo' ? 'bg-emerald-500' : 'bg-slate-300'}`}></div>
                        </div>
                        ...
                        <div className="w-full space-y-4">
                            <div className="flex items-center gap-3 text-left">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="text-sm font-bold text-slate-700 truncate">{technician.email || 'Não informado'}</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3 text-left">
                                <div className="size-10 rounded-xl bg-slate-50 flex items-center justify-center shrink-0">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="text-sm font-bold text-slate-700">{technician.contact}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        <div className="bg-white rounded-2xl border border-slate-200 p-5 flex items-center justify-between shadow-sm">
                            <div>
                                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Tempo Médio de Resolução</p>
                        ...
                        <div className="border border-slate-100 rounded-3xl overflow-visible shadow-inner-white">
                            ...
                            <div className="grid grid-cols-7 auto-rows-[100px]">
                                {(() => {
                                                                ...
                                                                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-56 bg-white rounded-xl shadow-2xl border border-slate-200 p-3 opacity-0 invisible group-hover/badge:opacity-100 group-hover/badge:visible transition-all duration-200 z-50 pointer-events-none">
                                                                    ...
                                                                    <div className="space-y-1">
                                                                        ...
                                                                        <div className="flex items-center gap-1.5">
                                                                            ...
                                                                            <span className={`text-[10px] font-bold px-1.5 py-0.5 rounded-md ${priorityColors[order.priority] || 'bg-slate-100 text-slate-600'}`}>{order.priority}</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    // Empty cells for next month to complete 5/6 rows (optional, but keeps grid stable)
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            {todayTasks.length === 0 && (
                                <div className="bg-slate-50 rounded-2xl border-2 border-dashed border-slate-200 p-12 text-center">
                                    ...
                                    <p className="text-sm font-bold text-slate-400 uppercase tracking-widest">Nenhuma tarefa para hoje</p>
                                </div>
                            )}
                        </div>
                    </div>
